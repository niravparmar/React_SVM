...
class Result extends React.Component {
    ...
    async componentDidMount() {
        ...
        var subjectResponse = await this.props.authenticatedApiCall('get', '/api/ProviderService/'+studentid+'/assignsubjects', null);
        var sub =[];
        ...
        var response = await this.props.authenticatedApiCall('get', '/api/providerservice/'+ studentid+'/getresult' , null);
           if(response.data){
...
export default withStyles(styles)(AuthenticatedPage(["Provider", "AccountAdmin", "SuperAdmin", "CoWorker"])(Result));
