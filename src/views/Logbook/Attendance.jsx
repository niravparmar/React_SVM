...
class Attendance extends React.Component {
    ...
    async componentDidMount() {
        ...
        var response = await this.props.authenticatedApiCall('get', '/api/ProviderService/'+studentid+'/studentattendance', null);
...
export default withStyles(styles)(AuthenticatedPage(["Provider", "AccountAdmin", "SuperAdmin", "CoWorker"])(Attendance));
